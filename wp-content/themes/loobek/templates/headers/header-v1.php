...
<header class="ts-header header-sticky menu-middle <?php echo esc_attr(implode(' ', $header_classes)); ?>">
	...
	<div class="header-template">
		<?php if( (function_exists('ts_header_social_icons') && $loobek_theme_options['ts_enable_header_social_icons']) || $loobek_theme_options['ts_header_mobile_layout'] =='v2' || $loobek_theme_options['ts_header_mobile_layout'] =='v3' || $loobek_theme_options['ts_second_menu_top_header'] || $loobek_theme_options['ts_header_language'] || $loobek_theme_options['ts_header_currency'] ): ?>	
		<div class="header-top">
			<div class="container">
				...
				<?php if( $loobek_theme_options['ts_second_menu_top_header'] || $loobek_theme_options['ts_header_language'] || $loobek_theme_options['ts_header_currency'] ): ?>
