				...
				<div class="account-dropdown-form dropdown-container">
					<div class="form-content">
						...
						<?php if( !$_user_logged ): ?>
							...
							<a class="forget-password button-text" href="<?php echo esc_url(wp_lostpassword_url()); ?>"><?php esc_html_e('I forget my password', 'loobek'); ?></a>
							<div class="create-account-wrapper">
								<span><?php esc_html_e('I\'m a new client.', 'loobek'); ?></span>
